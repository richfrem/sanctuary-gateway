...
# Example: export MCPGATEWAY_BEARER_TOKEN="ey..."
TOKEN="${MCPGATEWAY_BEARER_TOKEN:-your-jwt-token-here}"

if [ "$TOKEN" == "your-jwt-token-here" ]; then
    echo "⚠️  Warning: Token not set."
    echo "Usage: export MCPGATEWAY_BEARER_TOKEN='...' && ./verify_jwt_auth.sh"
